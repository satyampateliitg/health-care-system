...
<body class="container display-1">
  ...
  <h1 class="text-center font-weight-bold text-green  ">All The Doctor's Registration Request</h1>
  <hr></br>
    ...
    <table border="1" cellPadding="13" align="center" class="table table-hover table-dark">
      ...
      ?>
        ...
        <tr>
          ...
          <th>
            <h3><?php echo "<a style='color:green' href='appr.php?id={$row['email']}'>Approve ID</a>";  ?></h3>
          </th>
          <th>
            <h3><?php echo "<a style='color:red' href='req_delete.php?id={$row['email']}'>Reject ID</a>";  ?></h3>
          </th>
